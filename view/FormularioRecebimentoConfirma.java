...
public class FormularioRecebimentoConfirma extends FormulariosRecebimento {
	
	public FormularioRecebimentoConfirma() {
		formSelecionado = new FormRecebimentoConfirma();
	}
