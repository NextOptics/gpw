...
/*
		public FormularioBcontaEdita() {
		public static void show() {
		protected static void btnValidar_Act() {
*/


public class FormularioBcontaEdita extends FormulariosBconta {

	public FormularioBcontaEdita() {
		formSelecionado = new FormBcontaEdita();	
	}
	...
	public static void show() {
		...
		edtContaNumero.setDisable(true);
